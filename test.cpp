...
int main(int argc, char* argv[]) {
	if (argc != 7) {
		std::cout << argv[0] << " base_vec_path query_vec_path groundtruth_vec_path annoy_tree_num annoy_search_para nsg_search_para" << std::endl;
        return -1;
	}
   ...
   nsg->precision(limits, std::atoi(argv[6]), times, prec_sum, time_sum);
